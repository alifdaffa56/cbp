               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        for audio in audios:
                         if msg._from in admin:
                           if text.lower() == audio:
                              sendMention1(msg.to, sender, "「 CBP ʀᴇsᴜʟᴛ ᴍᴘ3 」\nsᴇʟᴀᴍᴀᴛ ᴍᴇɴɪᴋᴍᴀᴛɪ ᴋᴀᴋ ", "\nᴡᴀɪᴛɪɴɢ ᴘʀᴏɢʀᴇss ᴀᴜᴅɪᴏs..")
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendMessage(msg.to, "sᴇʟғ CBP ᴅɪᴀᴋᴛɪғᴋᴀɴ")
                                
                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendMessage(msg.to, "sᴇʟғ CBP ᴅɪ ɴᴏɴᴀᴋᴛɪғᴋᴀɴ")
                        ...
                        if cmd == "cbp4":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                zx2.append(zx)
                                zxc += pesan2
                                text = xpesan + zxc + ret_ + "┝────────────────\n│♠ CBP ᴄʟᴏᴄᴋ: 「"+ datetime.strftime(timeNow,'%H:%M:%S')+"」 "+"\n│♠ CBP ᴅᴀᴛᴇ: 「"+ datetime.strftime(timeNow,'%Y-%m-%d') +"」\n╰────ஜ۩CANNIBAL۩ஜ─────╯"
                                cl.sendMessage(msg.to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)

                        elif cmd == "creator" or text.lower() == 'creator':
                            if msg._from in admin:
                                cl.sendMessage(msg.to,"🔳🔳ᴄʀᴇᴀᴛᴏʀ cannibal🔲🔲") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                        ...
                        elif cmd == "cannibal" or text.lower() == 'cbpbot':
                                 tz = pytz.timezone("Asia/Jakarta")
                                 timeNow = datetime.now(tz=tz)
                                 rey = "CANNIBAL 「ケニザワ」\nᵀᴱᴬᴹCBP sᴇʟғʙᴏᴛ"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for group in saya:
                                   cl.sendMessage(group,"[🔳CBP sʜᴀʀᴇ🔲]\n" + str(pesan))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention1(msg.to, sender,"╔────ஜ۩CBP_sᴇʟғ۩ஜ─────╗\n│ᴡᴀɪᴛing ʙᴏss..\n│ᴘʀᴏɢʀᴇss ʀᴇsᴛᴀʀᴛ\n│ᴜsᴇʀ: ", " \n│ °CBP ʀᴇsᴛᴀʀᴛ° ᴅᴏɴᴇ°\n╚────ஜ۩CBP_sᴇʟғ۩ஜ─────╝")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to,"╔══[ CBP ғʀɪᴇɴᴅ ʟɪsᴛ ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Friends ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               cl.sendMessage(msg.to,"╔══[ CBP ɢʀᴏᴜᴘ ʟɪsᴛ ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "CBP sᴘᴇᴇᴅ ʀᴇsᴘᴏɴ\n\n - ɢᴇᴛ ᴘʀᴏғɪʟᴇ:\n%.10f\n - ɢᴇᴛ ᴄᴏɴᴛᴀᴄᴛ:\n%.10f\n - ɢᴇᴛ ɢʀᴏᴜᴘ\n%.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "╔────ஜ۩CBP_sᴇʟғ۩ஜ─────╗\n│  🔳ᴄᴇᴋ sɪᴅᴇʀ CBP ᴏɴ🔲\n┝───────────────────\n│🔳ᴛᴀɴɢɢᴀʟ: "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n│🔲ᴊᴀᴍ:  "+ datetime.strftime(timeNow,'%H:%M:%S')+"\n╚────ஜ۩CBP_sᴇʟғ۩ஜ─────╝")
          ...
          #                 if msg._from admin:
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                sendMention1(msg.to, sender,"╔────ஜ۩CANNIBAL۩ஜ─────╗\n│ᴡᴀɪᴛɪɴɢ ʙᴏss..\n│ᴘʀᴏɢʀᴇss ʏᴍᴘ4\n│ᴜsᴇʀ: ", " \n│ °CBP ᴜsᴇ° ᴠɪᴅᴇᴏs°\n╚────ஜ۩CANNIBAL۩ஜ─────╝")
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                              try:
                                  ...
                                  sendMention(msg.to, sender, " ʙᴀᴄᴋᴜᴘ ᴘʀᴏғɪʟᴇ CBP\nɴᴀᴍᴇ: ", " \nsᴜᴄᴄᴇss ʙᴀᴄᴋᴜᴘ ᴘʀᴏғɪʟᴇ")
                              except:
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = True
                                sendMention(msg.to, sender, "   sᴛᴀᴛᴜs ᴛɪᴍᴇʟɪɴᴇ CBP\nᴜsᴇʀ: @! \nsᴇɴᴅ ʏᴏᴜʀ ᴘᴏsᴛ,\nʟɪᴋᴇ ᴅᴏɴᴇ-> ᴛᴏ ᴏғғ: ᴛɪᴍᴇʟɪɴᴇ ᴏғғ")
...
#===========COMMAND SET============#
                           ...
                           if wait["Timeline"] == True:
                              ...
                              cl.sendMessage(msg.to, "cbp ʟɪᴋᴇ ᴅᴏɴᴇ ʙᴏss")
